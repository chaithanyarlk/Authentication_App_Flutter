...
class ForgetPassword extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: ForgetPasswordPage(), // ForgetPasswordPage is the landing page of the app
    );
  }
}
            ...
            children: <Widget>[
              AppBar(
                ...
                leading: new IconButton(
                  ...
                  onPressed: (){Navigator.push(context, new MaterialPageRoute(builder: (context) => new SignIn()),);}
